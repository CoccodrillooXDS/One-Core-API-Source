...
@ stdcall CloseDesktop(ptr) ;NtUserCloseDesktop
...
@ stdcall CreateWindowExA(long str str long long long long long ptr ptr ptr ptr)
@ stdcall CreateWindowExW(long wstr wstr long long long long long ptr ptr ptr ptr)
...
@ stdcall DefWindowProcA(ptr long long long)
@ stdcall DefWindowProcW(ptr long long long)
...
@ stdcall DestroyWindow(ptr) ;NtUserDestroyWindow
...
@ stdcall DialogBoxParamA(ptr str ptr ptr long)
@ stdcall DialogBoxParamW(ptr wstr ptr ptr long)
...
@ stdcall GetDlgItem(ptr long)
@ stdcall GetDlgItemInt(long long ptr long)
@ stdcall GetDlgItemTextA(ptr long ptr long)
@ stdcall GetDlgItemTextW(ptr long ptr long)
...
@ stdcall GetWindowLongW(ptr long)
...
@ stdcall GetWindowThreadProcessId(ptr ptr)
...
@ stdcall InitializeWin32EntryTable(ptr) userbase.InitializeWin32EntryTable
...
@ stdcall MessageBoxW(ptr wstr wstr long)
...
@ stdcall PeekMessageA(ptr ptr long long long)
@ stdcall PeekMessageW(ptr ptr long long long)
@ stdcall PostMessageA(ptr long long long)
@ stdcall PostMessageW(ptr long long long)
...
@ stdcall RegisterDeviceNotificationA(ptr ptr long) RegisterDeviceNotificationW
@ stdcall RegisterDeviceNotificationW(ptr ptr long) userbase.RegisterDeviceNotificationW
...
@ stdcall SendMessageW(ptr long long long)
...
@ stdcall SetDlgItemTextA(ptr long str)
@ stdcall SetDlgItemTextW(ptr long wstr)
@ stdcall SetDoubleClickTime(long)
@ stdcall SetFocus(long) ;NtUserSetFocus
@ stdcall SetForegroundWindow(ptr)
...
@ stdcall SetSystemTimer(long long long ptr) ;Server 2003 RTM don't has this function
@ stdcall SetTaskmanWindow (long)
@ stdcall SetThreadDesktop(ptr) ;NtUserSetThreadDesktop
@ stdcall SetTimer(ptr long long ptr) ;NtUserSetTimer
...
@ stdcall UnregisterClassA(str ptr)
@ stdcall UnregisterClassW(wstr ptr)
@ stdcall UnregisterDeviceNotification(ptr)
...
@ stdcall GetWindowMinimizeRect(ptr ptr)
@ stdcall GetWindowRgnEx(ptr ptr long)
@ stdcall GhostWindowFromHungWindow(long) ;implemented
@ stub gSharedInfo
@ stdcall HungWindowFromGhostWindow(long) ;implemented
@ stdcall InternalGetWindowIcon(ptr ptr)
@ stdcall IsProcessDPIAware()
@ stdcall IsThreadDesktopComposited()
@ stdcall IsTopLevelWindow(ptr)
@ stdcall IsTouchWindow(ptr ptr)
@ stdcall IsWindowRedirectedForPrint(ptr)
@ stdcall LogicalToPhysicalPoint(ptr ptr)
@ stdcall MBToWCSEx(long str long wstr long long)
@ stdcall NotifyOverlayWindow(ptr long)
...
@ stdcall SetDisplayAutoRotationPreferences(ptr)
@ stdcall SetDisplayConfig(long ptr long ptr long)
@ stdcall SetGestureConfig(ptr long long ptr long)
@ stdcall SetMagnificationDesktopColorEffect(ptr)
@ stdcall SetMagnificationDesktopMagnification(double long long)
...
@ stub SfmDxQuerySwapChainBindingStatus
@ stub SfmDxReleaseSwapChain
@ stub SfmDxReportPendingBindingsToDwm
@ stub SfmDxSetSwapChainBindingStatus
@ stub SfmDxSetSwapChainStats 
@ stdcall ShowSystemCursor(long)
...
@ stdcall WindowFromPhysicalPoint(double) ;NtUserWindowFromPhysicalPoint ;Vista Function
@ stdcall VTagOutput()
@ stdcall VRipOutput()
